...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee(){
        ...
        heading.setFont(new Font("SAN_SERTF",Font.BOLD,25));
        add(heading);
        ...
        String courses[] = {" ","BBA","BCA","B.COM","BTECH","MBA","MCA","MA","MTECH","MSC"};
        cbeducation = new JComboBox(courses);
         cbeducation.setBackground(Color.WHITE);
        cbeducation.setBounds(600,300,150,30);
        add(cbeducation);

        JLabel labelldegination = new JLabel("Designation");
        labelldegination.setBounds(50,350,150,30);
        labelldegination.setFont(new Font("serif",Font.BOLD,20));
        add(labelldegination);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == add){
            ...
            try{
                Conn conn = new Conn();
                String query = "insert into employee values ('"+name+"','"+fname+"','"+dob+"','"+salary+"','"+phone+"','"+education+"','"+designation+"','"+aadhar+"','"+empId+"','"+address+"','"+email+"',)";
